defmodule GitClone.GistsTest do
  use GitClone.DataCase

  alias GitClone.Gists

  describe "gists" do
    alias GitClone.Gists.Gist

    import GitClone.GistsFixtures
  ...
  describe "saved_gists" do
    alias GitClone.Gists.SavedGist
